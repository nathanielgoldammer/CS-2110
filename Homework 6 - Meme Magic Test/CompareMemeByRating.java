...
public class CompareMemeByRating implements Comparator<Meme>
{
     ...
     * Then, if the memes' captions are identical, by BackgroundImage (using its natural ordering)
     * Lastly, if the memes' BackgroundImages are identical, by creator (using its natural ordering)
     * 
    ...
    public int compare(Meme meme1, Meme meme2)
    {
        ...
        if(meme1.calculateOverallRating() - meme2.calculateOverallRating() != 0)
        {
        ...
        else if(meme1.getCreator().compareTo(meme2.getCreator()) != 0)
        {
    ...
    public static void main(String[] args)
    {
        ...
        //compare Test 2 - Expected Output: "meme1 before meme2 by creator"
        ...
        //compare Test 4 - Expected Output: "meme1 before meme2 by caption"
        ...
        //compare Test 5 - Expected Output: "meme1 before meme2 by overall rating"
        User user = new User();
